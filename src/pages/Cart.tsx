...
export const Cart: React.FC = () => {
  ...
  // ── FIX 1: use navigate() instead of <Link to="/checkout">
  ...
  return (
    <div
      ...
      className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12 space-y-12"
    >
      {/* Title block */}
        ...
        <div className="py-24 text-center space-y-4 bg-white border border-luxury-beige-200 rounded max-w-2xl mx-auto">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-stone-500 max-w-sm mx-auto leading-relaxed">
              We hand-paint every coordinate using professional gels cured with
              micro lamps. Explore our exquisite templates to configure yours!
            </p>
          </div>
          <Link
            to="/shop"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-4">
            {cart.map((item, idx) => (
              ...
              >
                ...
                <div className="flex-1 space-y-2 min-w-0">
                  ...
                  {/*
                   * ── FIX 2: Removed shape / length / size badges
                   *    and the millimeter sizing detail line.
                   *    Only show the product name and qty controls below.
                   */}
            ...
            <div className="bg-luxury-beige-200 border border-luxury-beige-300 rounded p-4 flex items-start space-x-3 text-xs leading-normal">
              <Calendar
                size={16}
                className="text-luxury-gold shrink-0 mt-0.5 animate-pulse"
              />
              <div>
                <strong className="text-luxury-charcoal block">
                  Hand-Cured Sanitary Dispatch Policy:
                </strong>
                <span className="text-stone-600 text-[11px] block mt-0.5">
                  Due to high-quality gel curing (Japanese building coatings
                  paint formulas), preparation from our Navsari studio requires
                  3–5 days of craft before courier dispatch. Sizing coordinates
                  and shapes cannot be modified once custom prep has commenced.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 bg-white border border-luxury-beige-200 rounded p-5 space-y-5 sticky top-28 shadow-xs">
            ...
            <div className="space-y-1.5">
              ...
              {couponError && (
                <p className="text-[10px] text-red-500 font-mono italic mt-1">
                  {couponError}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2.5 pt-2 text-xs text-stone-650">
              <div className="flex justify-between">
                ...
                <span className="font-mono text-luxury-charcoal font-semibold">
              ...
              {shippingCharge > 0 && (
                <div className="bg-luxury-beige-100 p-2.5 rounded border border-luxury-beige-300 text-[10px] text-stone-500 text-center italic">
                  💸 Add ₹{(1499 - subtotal).toLocaleString('en-IN')} more to
                  your luxury box and trigger{' '}
                  <strong>FREE panels shipping</strong> instantly!
                </div>
              )}
            ...
            <div className="bg-stone-50 p-3 rounded text-[10px] text-stone-500 space-y-1.5 leading-relaxed font-sans mt-3.5 border border-stone-150">
              <div className="flex items-start space-x-1.5">
                ...
                <span>
                  Sanitary standardizations prevent cancellation once items are
                  size-cured.
                </span>
              </div>
              <div className="flex items-start space-x-1.5">
                <AlertCircle size={12} className="text-luxury-gold shrink-0 mt-0.5" />
                <span>
                  Final order coordinates automatically exported to WhatsApp on
                  checkout.
                </span>
              </div>
            </div>
            ...
            <div className="pt-2 space-y-3">
              {/*
               * ── FIX 1: replaced <Link to="/checkout"> with a button
               *    that calls navigate('/checkout') — this fixes the
               *    "doesn't navigate on first click, only after refresh" bug.
               */}
              <button
